...
3. 각 공고에 대해 **fit_score**를 산출하라 (가산 방식, 최대 10점):
   - React 매칭: +3점 (기술스택에 React 포함 시)
   - TypeScript 매칭: +3점 (기술스택에 TypeScript 포함 시)
   - SSE 경험: +2점 (기술스택 또는 직무 설명에 SSE, Server-Sent Events, 실시간 스트리밍, EventSource 포함 시)
